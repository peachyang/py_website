...
class SearchController extends CategoryController
{
    ...
    {
        $interval = (int) $this->getContainer()->get('config')['article/product/search_interval'];
        ...
        if (isset($data['q'])) {
            ...
            $result = $engine->select('article_search', $data, $languageId);
            $ids = [];
