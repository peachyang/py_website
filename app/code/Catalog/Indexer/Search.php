        ...
        if ($handler instanceof Database) {
            ...
            foreach ($languages as $language) {
                ...
                if ($platform->getName() === 'MySQL') {
                    $adapter->query(
                            'CREATE TABLE `' . $table . '`(`id` INTEGER NOT NULL,`data` LONGTEXT,PRIMARY KEY (`id`),FULLTEXT KEY `FTI_CATALOG_SEARCH_FULLTEXT_DATA` (`data`)) ENGINE=MyISAM;', $adapter::QUERY_MODE_EXECUTE
                    );
                } else {
