...
CREATE TABLE IF NOT EXISTS `livechat_session` (
    ...
    `customer_id_1` INTEGER UNSIGNED NOT NULL,
    `customer_id_2` INTEGER UNSIGNED NOT NULL,
    PRIMARY KEY(`id`),
    INDEX IDX_LIVECHAT_SESSION_CUSTOMER_ID_2 (`customer_id_2`),
    CONSTRAINT UNQ_LIVECHAT_SESSION_CUSTOMER_ID_1_CUSTOMER_ID_2 UNIQUE (`customer_id_1`,`customer_id_2`),
    CONSTRAINT FK_LIVECHAT_SESSION_CUSTOMER_ID_1_CUSTOMER_ENTITY_ID FOREIGN KEY (`customer_id_1`) REFERENCES `customer_entity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_LIVECHAT_SESSION_CUSTOMER_ID_2_CUSTOMER_ENTITY_ID FOREIGN KEY (`customer_id_2`) REFERENCES `customer_entity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
);
