...
CREATE TABLE IF NOT EXISTS `sales_rma_item`(
    `id` INTEGER UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'RMA item ID',
    `rma_id` INTEGER UNSIGNED NOT NULL COMMENT 'RMA ID',
    `item_id` INTEGER UNSIGNED NOT NULL COMMENT 'Order item ID',
...
CREATE TABLE IF NOT EXISTS `log_rma` (
    `id` INTEGER UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `rma_id` INTEGER UNSIGNED NOT NULL COMMENT 'RMA ID',
    `is_customer` BOOLEAN NOT NULL DEFAULT 0 COMMENT 'Is customer',
    `comment` BLOB COMMENT 'Comment',
