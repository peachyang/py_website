...
//    {
//        $this->init('article_option', 'id', ['id', 'article_id', 'input', 'is_required', 'sku', 'price', 'is_fixed', 'sort_order']);
//    }
//
...
//    {
//        if ($this->getId()) {
//            $tableGateway = $this->getTableGateway('article_option_title');
...
//                            ->where(['article_option_value_title.language_id' => $this->getLanguageId()])
...
//                $tableGateway = $this->getTableGateway('article_option_value');
//                $select = $tableGateway->getSql()->select();
//                $select->where(['option_id' => $this->getId(), 'article_option_value.id' => $value]);
//                $select->join('article_option_value_title', 'article_option_value.id=article_option_value_title.value_id', ['title'], 'left')
//                        ->where(['article_option_value_title.language_id' => $this->getLanguageId()]);
...
//            $obj = $this;
//        }
//        if ($this->offsetGet('article_id') == $obj->offsetGet('article_id')) {
//            return true;
//        } else {
//            $this->setId(null);
//            return false;
...
//            $tableGateway = $this->getTableGateway('article_option_value');
//            $titleGateway = $this->getTableGateway('article_option_value_title');
