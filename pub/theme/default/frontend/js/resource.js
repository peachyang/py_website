(function (factory) {
    if (typeof define === "function" && define.amd) {
        define(["jquery", "modal", "collapse", "jquery.fileupload", "jquery.ui.sortable"], factory);
    } else if (typeof exports === "object") {
        factory(require(["jquery", "modal", "collapse", "jquery.fileupload", "jquery.ui.sortable"]));
    } else {
        factory(jQuery);
    }
}(function ($) {
        ...
        var widgetUpload = {
            ...
            init: function () {
                ...
                $('#resource-list').on('click', 'a.select', function () {
                    ...
                    return false;
                }).on('dblclick', '[data-folder]', function () {
                    $('.resource-explorer .nav a[data-toggle=collapse][href="' + $(this).data('folder') + '"]').trigger('click');
                });
                ...
                $('.resource-explorer').on('click', '.nav a[data-toggle=collapse]', function () {
                    if (!$(this).is('.active')) {
                ...
                }).on('show.bs.collapse', '.nav .collapse', function () {
