...
CREATE TABLE IF NOT EXISTS `retailer_manager`(
    ...
    CONSTRAINT FK_RETAILER_CUSTOMER_MANAGER_ID_CUSTOMER_ENTITY_ID FOREIGN KEY (`customer_id`) REFERENCES `customer_entity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_RETAILER_CUSTOMER_MANAGER_ID_RETAILER_ID FOREIGN KEY (`retailer_id`) REFERENCES `retailer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
);
