...
CREATE TABLE IF NOT EXISTS `livechat_session` (
    ...
    INDEX IDX_LIVECHAT_SESSION_CUSTOMER_ID (`customer_id`),
    CONSTRAINT FK_LIVECHAT_SESSION_CUSTOMER_ID_1_CUSTOMER_ENTITY_ID FOREIGN KEY (`customer_id`) REFERENCES `customer_entity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
);
