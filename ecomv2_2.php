...
CREATE TABLE IF NOT EXISTS `sales_cart` (
    `id` INTEGER NOT NULL AUTO_INCREMENT COMMENT 'Cart ID',
    `customer_id` INTEGER DEFAULT NULL COMMENT 'Customer ID',
    `store_id` INTEGER DEFAULT NULL COMMENT 'Store ID',
    `coupon` VARCHAR(255) DEFAULT NULL COMMENT 'Coupon code',
    ...
    `is_active` BOOLEAN NOT NULL DEFAULT 1 COMMENT 'Is active',
    `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT 'Created at',
    `updated_at` DATETIME NULL DEFAULT NULL COMMENT 'Updated at',
    PRIMARY KEY (`id`),
    INDEX IDX_SALES_CART_CUSTOMER_ID (`customer_id`),
    INDEX IDX_SALES_CART_STORE_ID (`store_id`),
    INDEX IDX_SALES_CART_IS_ACTIVE (`is_active`),
    ...
    CONSTRAINT FK_SALES_CART_STORE_ID_CORE_STORE_ID FOREIGN KEY (`store_id`) REFERENCES `core_store`(`id`) ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `sales_cart_item` (
    ...
    `base_total` DECIMAL(12,4) NOT NULL COMMENT 'Base total',
    `total` DECIMAL(12,4) NOT NULL COMMENT 'Total',
    `base_total_incl_tax` DECIMAL(12,4) NOT NULL COMMENT 'Base total including tax',
    `total_incl_tax` DECIMAL(12,4) NOT NULL COMMENT 'Total including tax',
    ...
    INDEX IDX_SALES_CART_ITEM_IS_ACTIVE (`is_active`),
...
CREATE TABLE IF NOT EXISTS `sales_order_shipment_track` (
    ...
    `carrier_code` VARCHAR(32) NOT NULL COMMENT 'Carrier code',
