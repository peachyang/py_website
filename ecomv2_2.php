...
CREATE TABLE IF NOT EXISTS `retailer`(
    ...
    `description` TEXT COMMENT 'Description',
    `profile` INTEGER NULL DEFAULT NULL COMMENT 'Profile',
    `banner` INTEGER NULL DEFAULT NULL COMMENT 'Banner',
    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT 'Created at',
    PRIMARY KEY (`id`),
    ...
    CONSTRAINT FK_RETAILER_PROFILE_RESOURCE_ID FOREIGN KEY (`profile`) REFERENCES `resource` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_RETAILER_BANNER_RESOURCE_ID FOREIGN KEY (`banner`) REFERENCES `resource` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `store_decoration_picinfo` (
    ...
    `store_id` INTEGER NOT NULL COMMENT 'Store ID',
    `resource_id` INTEGER NULL DEFAULT NULL COMMENT 'Resource ID',
