...
CREATE TABLE IF NOT EXISTS `core_translate`(
    ...
    `updated_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT 'Updated time',
    PRIMARY KEY (`id`),
    INDEX IDX_CORE_TRANSLATE_LOCALE_STATUS (`locale`,`status`),
    INDEX IDX_CORE_TRANSLATE_STRING_LOCALE_STATUS (`string`,`locale`,`status`)
);

CREATE TRIGGER `TGR_UPDATE_CORE_TRANSLATE` BEFORE UPDATE ON `core_translate` FOR EACH ROW SET NEW.`updated_at`=CURRENT_TIMESTAMP;
...
CREATE TABLE IF NOT EXISTS `resource_category` (
    ...
    `parent_id` INTEGER DEFAULT NULL COMMENT 'Parent category ID',
...
CREATE TABLE IF NOT EXISTS `resource_category_language` (
    ...
    INDEX IDX_RESOURCE_CATEGORY_LANGUAGE_LANGUAGE_ID (`category_id`),
...
CREATE TABLE IF NOT EXISTS `resource` (
    ...
    `store_id` INTEGER DEFAULT NULL COMMENT 'Store ID',
    `category_id` INTEGER DEFAULT NULL COMMENT 'Category ID',
