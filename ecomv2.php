...
CREATE TABLE IF NOT EXISTS `page_category_entity` (
    `id` INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
    `type_id` INTEGER UNSIGNED NOT NULL DEFAULT 3,
    `parent_id` INTEGER UNSIGNED NULL DEFAULT NULL,
    `attribute_set_id` INTEGER UNSIGNED NOT NULL,
    ...
    `updated_at` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    INDEX IDX_PAGE_CATEGORY_ENTITY_PARENT_ID (`parent_id`),
    INDEX IDX_PAGE_CATEGORY_ENTITY_TYPE_ID (`type_id`),
    INDEX IDX_PAGE_CATEGORY_ENTITY_ATTRIBUTE_SET_ID (`attribute_set_id`),
    CONSTRAINT FK_PAGE_CATEGORY_ENTITY_PARENT_ID_PAGE_CATEGORY_ENTITY_ID FOREIGN KEY (`parent_id`) REFERENCES `page_category_entity`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_CATEGORY_ENTITY_TYPE_ID_EAV_ENTITY_TYPE_ID FOREIGN KEY (`type_id`) REFERENCES `eav_entity_type`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_CATEGORY_ENTITY_ATTR_SET_ID_EAV_ATTR_SET_ID FOREIGN KEY (`attribute_set_id`) REFERENCES `eav_attribute_set`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS `page_category_value_datetime` (
    `attribute_id` INTEGER UNSIGNED NOT NULL,
    `language_id` INTEGER UNSIGNED NOT NULL,
    `entity_id` INTEGER UNSIGNED NOT NULL,
    `value` TIMESTAMP NOT NULL,
    `updated_at` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`attribute_id`,`language_id`,`entity_id`),
    INDEX IDX_PAGE_CATEGORY_VALUE_DATETIME_LANGUAGE_ID (`language_id`),
    INDEX IDX_PAGE_CATEGORY_VALUE_DATETIME_ENTITY_ID (`entity_id`),
    INDEX IDX_PAGE_CATEGORY_VALUE_DATETIME_ATTR_ID_VALUE (`attribute_id`,`value`),
    INDEX IDX_PAGE_CATEGORY_VALUE_DATETIME_ENTITY_ID_VALUE (`entity_id`,`value`),
    CONSTRAINT FK_PAGE_CATEGORY_VALUE_DATETIME_ATTR_ID_EAV_ATTR_ID FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_CATEGORY_VALUE_DATETIME_LANGUAGE_ID_CORE_LANGUAGE_ID FOREIGN KEY (`language_id`) REFERENCES `core_language`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_CATEGORY_VALUE_DATETIME_ENTITY_ID_PAGE_ENTITY_ID FOREIGN KEY (`entity_id`) REFERENCES `page_entity`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS `page_category_value_decimal` (
    `attribute_id` INTEGER UNSIGNED NOT NULL,
    `language_id` INTEGER UNSIGNED NOT NULL,
    `entity_id` INTEGER UNSIGNED NOT NULL,
    `value` DECIMAL(12,4) NOT NULL,
    `updated_at` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`attribute_id`,`language_id`,`entity_id`),
    INDEX IDX_PAGE_CATEGORY_VALUE_DECIMAL_LANGUAGE_ID (`language_id`),
    INDEX IDX_PAGE_CATEGORY_VALUE_DECIMAL_ENTITY_ID (`entity_id`),
    INDEX IDX_PAGE_CATEGORY_VALUE_DECIMAL_ATTR_ID_VALUE (`attribute_id`,`value`),
    INDEX IDX_PAGE_CATEGORY_VALUE_DECIMAL_ENTITY_ID_VALUE (`entity_id`,`value`),
    CONSTRAINT FK_PAGE_CATEGORY_VALUE_DECIMAL_ATTR_ID_EAV_ATTR_ID FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_CATEGORY_VALUE_DECIMAL_LANGUAGE_ID_CORE_LANGUAGE_ID FOREIGN KEY (`language_id`) REFERENCES `core_language`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_CATEGORY_VALUE_DECIMAL_ENTITY_ID_PAGE_ENTITY_ID FOREIGN KEY (`entity_id`) REFERENCES `page_entity`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS `page_category_value_varchar` (
    `attribute_id` INTEGER UNSIGNED NOT NULL,
    `language_id` INTEGER UNSIGNED NOT NULL,
    `entity_id` INTEGER UNSIGNED NOT NULL,
    `value` VARCHAR(255) NOT NULL,
    `updated_at` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`attribute_id`,`language_id`,`entity_id`),
    INDEX IDX_PAGE_CATEGORY_VALUE_VARCHAR_LANGUAGE_ID (`language_id`),
    INDEX IDX_PAGE_CATEGORY_VALUE_VARCHAR_ENTITY_ID (`entity_id`),
    INDEX IDX_PAGE_CATEGORY_VALUE_VARCHAR_ATTR_ID_VALUE (`attribute_id`,`value`),
    INDEX IDX_PAGE_CATEGORY_VALUE_VARCHAR_ENTITY_ID_VALUE (`entity_id`,`value`),
    CONSTRAINT FK_PAGE_CATEGORY_VALUE_VARCHAR_ATTR_ID_EAV_ATTR_ID FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_CATEGORY_VALUE_VARCHAR_LANGUAGE_ID_CORE_LANGUAGE_ID FOREIGN KEY (`language_id`) REFERENCES `core_language`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_CATEGORY_VALUE_VARCHAR_ENTITY_ID_PAGE_ENTITY_ID FOREIGN KEY (`entity_id`) REFERENCES `page_entity`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS `page_category_value_text` (
    `attribute_id` INTEGER UNSIGNED NOT NULL,
    `language_id` INTEGER UNSIGNED NOT NULL,
    `entity_id` INTEGER UNSIGNED NOT NULL,
    `value` MEDIUMTEXT NOT NULL,
    `updated_at` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`attribute_id`,`language_id`,`entity_id`),
    INDEX IDX_PAGE_CATEGORY_VALUE_TEXT_LANGUAGE_ID (`language_id`),
    INDEX IDX_PAGE_CATEGORY_VALUE_TEXT_ENTITY_ID (`entity_id`),
    CONSTRAINT FK_PAGE_CATEGORY_VALUE_TEXT_ATTR_ID_EAV_ATTR_ID FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_CATEGORY_VALUE_TEXT_LANGUAGE_ID_CORE_LANGUAGE_ID FOREIGN KEY (`language_id`) REFERENCES `core_language`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_CATEGORY_VALUE_TEXT_ENTITY_ID_PAGE_ENTITY_ID FOREIGN KEY (`entity_id`) REFERENCES `page_entity`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `page_entity` (
    ...
    `updated_at` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    INDEX IDX_PAGE_ENTITY_TYPE_ID (`type_id`),
    INDEX IDX_PAGE_ENTITY_ATTRIBUTE_SET_ID (`attribute_set_id`),
    CONSTRAINT FK_PAGE_ENTITY_TYPE_ID_EAV_ENTITY_TYPE_ID FOREIGN KEY (`type_id`) REFERENCES `eav_entity_type`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_ENTITY_ATTR_SET_ID_EAV_ATTR_SET_ID FOREIGN KEY (`attribute_set_id`) REFERENCES `eav_attribute_set`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS `page_value_int` (
    `attribute_id` INTEGER UNSIGNED NOT NULL,
    `language_id` INTEGER UNSIGNED NOT NULL,
    `entity_id` INTEGER UNSIGNED NOT NULL,
    `value` INTEGER NOT NULL,
    `updated_at` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`attribute_id`,`language_id`,`entity_id`),
    INDEX IDX_PAGE_VALUE_INT_LANGUAGE_ID (`language_id`),
    INDEX IDX_PAGE_VALUE_INT_ENTITY_ID (`entity_id`),
    INDEX IDX_PAGE_VALUE_INT_ATTR_ID_VALUE (`attribute_id`,`value`),
    INDEX IDX_PAGE_VALUE_INT_ENTITY_ID_VALUE (`entity_id`,`value`),
    CONSTRAINT FK_PAGE_VALUE_INT_ATTR_ID_EAV_ATTR_ID FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_VALUE_INT_LANGUAGE_ID_CORE_LANGUAGE_ID FOREIGN KEY (`language_id`) REFERENCES `core_language`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_VALUE_INT_ENTITY_ID_PAGE_ENTITY_ID FOREIGN KEY (`entity_id`) REFERENCES `page_entity`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS `page_value_datetime` (
    `attribute_id` INTEGER UNSIGNED NOT NULL,
    `language_id` INTEGER UNSIGNED NOT NULL,
    `entity_id` INTEGER UNSIGNED NOT NULL,
    `value` TIMESTAMP NOT NULL,
    `updated_at` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`attribute_id`,`language_id`,`entity_id`),
    INDEX IDX_PAGE_VALUE_DATETIME_LANGUAGE_ID (`language_id`),
    INDEX IDX_PAGE_VALUE_DATETIME_ENTITY_ID (`entity_id`),
    INDEX IDX_PAGE_VALUE_DATETIME_ATTR_ID_VALUE (`attribute_id`,`value`),
    INDEX IDX_PAGE_VALUE_DATETIME_ENTITY_ID_VALUE (`entity_id`,`value`),
    CONSTRAINT FK_PAGE_VALUE_DATETIME_ATTR_ID_EAV_ATTR_ID FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_VALUE_DATETIME_LANGUAGE_ID_CORE_LANGUAGE_ID FOREIGN KEY (`language_id`) REFERENCES `core_language`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_VALUE_DATETIME_ENTITY_ID_PAGE_ENTITY_ID FOREIGN KEY (`entity_id`) REFERENCES `page_entity`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS `page_value_decimal` (
    `attribute_id` INTEGER UNSIGNED NOT NULL,
    `language_id` INTEGER UNSIGNED NOT NULL,
    `entity_id` INTEGER UNSIGNED NOT NULL,
    `value` DECIMAL(12,4) NOT NULL,
    `updated_at` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`attribute_id`,`language_id`,`entity_id`),
    INDEX IDX_PAGE_VALUE_DECIMAL_LANGUAGE_ID (`language_id`),
    INDEX IDX_PAGE_VALUE_DECIMAL_ENTITY_ID (`entity_id`),
    INDEX IDX_PAGE_VALUE_DECIMAL_ATTR_ID_VALUE (`attribute_id`,`value`),
    INDEX IDX_PAGE_VALUE_DECIMAL_ENTITY_ID_VALUE (`entity_id`,`value`),
    CONSTRAINT FK_PAGE_VALUE_DECIMAL_ATTR_ID_EAV_ATTR_ID FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_VALUE_DECIMAL_LANGUAGE_ID_CORE_LANGUAGE_ID FOREIGN KEY (`language_id`) REFERENCES `core_language`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_VALUE_DECIMAL_ENTITY_ID_PAGE_ENTITY_ID FOREIGN KEY (`entity_id`) REFERENCES `page_entity`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS `page_value_varchar` (
    `attribute_id` INTEGER UNSIGNED NOT NULL,
    `language_id` INTEGER UNSIGNED NOT NULL,
    `entity_id` INTEGER UNSIGNED NOT NULL,
    `value` VARCHAR(255) NOT NULL,
    `updated_at` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`attribute_id`,`language_id`,`entity_id`),
    INDEX IDX_PAGE_VALUE_VARCHAR_LANGUAGE_ID (`language_id`),
    INDEX IDX_PAGE_VALUE_VARCHAR_ENTITY_ID (`entity_id`),
    INDEX IDX_PAGE_VALUE_VARCHAR_ATTR_ID_VALUE (`attribute_id`,`value`),
    INDEX IDX_PAGE_VALUE_VARCHAR_ENTITY_ID_VALUE (`entity_id`,`value`),
    CONSTRAINT FK_PAGE_VALUE_VARCHAR_ATTR_ID_EAV_ATTR_ID FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_VALUE_VARCHAR_LANGUAGE_ID_CORE_LANGUAGE_ID FOREIGN KEY (`language_id`) REFERENCES `core_language`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_VALUE_VARCHAR_ENTITY_ID_PAGE_ENTITY_ID FOREIGN KEY (`entity_id`) REFERENCES `product_entity`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS `page_value_text` (
    `attribute_id` INTEGER UNSIGNED NOT NULL,
    `language_id` INTEGER UNSIGNED NOT NULL,
    `entity_id` INTEGER UNSIGNED NOT NULL,
    `value` MEDIUMTEXT NOT NULL,
    `updated_at` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`attribute_id`,`language_id`,`entity_id`),
    INDEX IDX_PAGE_VALUE_TEXT_LANGUAGE_ID (`language_id`),
    INDEX IDX_PAGE_VALUE_TEXT_ENTITY_ID (`entity_id`),
    CONSTRAINT FK_PAGE_VALUE_TEXT_ATTR_ID_EAV_ATTR_ID FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_VALUE_TEXT_LANGUAGE_ID_CORE_LANGUAGE_ID FOREIGN KEY (`language_id`) REFERENCES `core_language`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_VALUE_TEXT_ENTITY_ID_PAGE_ENTITY_ID FOREIGN KEY (`entity_id`) REFERENCES `page_entity`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `page_option` (
    ...
    `sort_order` INTEGER DEFAULT 0,
    PRIMARY KEY (`id`),
    INDEX IDX_PAGE_OPTION_PAGE_ID (`page_id`),
    INDEX IDX_PAGE_OPTION_SORT_ORDER (`sort_order`),
    CONSTRAINT FK_PAGE_OPTION_PAGE_ID_PAGE_ENTITY_ID FOREIGN KEY (`page_id`) REFERENCES `page_entity`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS `page_option_title` (
    `option_id` INTEGER UNSIGNED NOT NULL,
    `language_id` INTEGER UNSIGNED NOT NULL,
    `title` VARCHAR(255) DEFAULT '',
    PRIMARY KEY (`option_id`,`language_id`),
    INDEX IDX_PAGE_OPTION_TITLE_LANGUAGE_ID (`language_id`),
    CONSTRAINT FK_PAGE_OPTION_TITLE_OPTION_ID_PAGE_OPTION_ID FOREIGN KEY (`option_id`) REFERENCES `page_option`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_OPTION_TITLE_OPTION_ID_CORE_LANGUAGE_ID FOREIGN KEY (`language_id`) REFERENCES `core_language`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `page_option_value` (
    ...
    `sort_order` INTEGER DEFAULT 0,
    PRIMARY KEY (`id`),
    INDEX IDX_PAGE_OPTION_VALUE_OPTION_ID (`option_id`),
    INDEX IDX_PAGE_OPTION_VALUE_SORT_ORDER (`sort_order`),
    CONSTRAINT FK_PAGE_OPTION_VALUE_OPTION_ID_PAGE_OPTION_ID FOREIGN KEY (`option_id`) REFERENCES `page_option`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS `page_option_value_title` (
    `value_id` INTEGER UNSIGNED NOT NULL,
    `language_id` INTEGER UNSIGNED NOT NULL,
    `title` VARCHAR(255) DEFAULT '',
    PRIMARY KEY (`value_id`,`language_id`),
    INDEX IDX_PAGE_OPTION_VALUE_TITLE_LANGUAGE_ID (`language_id`),
    CONSTRAINT FK_PAGE_OPTION_VALUE_TITLE_OPTION_ID_PAGE_VALUE_ID FOREIGN KEY (`value_id`) REFERENCES `page_option_value`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_OPTION_VALUE_TITLE_OPTION_ID_CORE_LANGUAGE_ID FOREIGN KEY (`language_id`) REFERENCES `core_language`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS `page_link` (
    `page_id` INTEGER UNSIGNED NOT NULL,
    `linked_page_id` INTEGER UNSIGNED NOT NULL,
    `type` CHAR(1) NOT NULL,
    `sort_order` INTEGER DEFAULT 0,
    PRIMARY KEY (`page_id`,`linked_page_id`,`type`),
    INDEX IDX_PAGE_LINK_LINKED_PAGE_ID (`linked_page_id`),
    INDEX IDX_PAGE_LINK_SORT_ORDER (`sort_order`),
    CONSTRAINT FK_PAGE_LINK_PAGE_ID_PAGE_ENTITY_ID FOREIGN KEY (`page_id`) REFERENCES `page_entity`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_LINK_LINKED_PAGE_ID_PAGE_ENTITY_ID FOREIGN KEY (`linked_page_id`) REFERENCES `page_entity`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `page_in_category` (
    `page_id` INTEGER UNSIGNED NOT NULL,
    `category_id` INTEGER UNSIGNED NOT NULL,
    `sort_order` INTEGER DEFAULT 0,
    PRIMARY KEY (`page_id`,`category_id`),
    INDEX IDX_PAGE_IN_CATEGORY_CATEGORY_ID (`category_id`),
    INDEX IDX_PAGE_IN_CATEGORY_SORT_ORDER (`sort_order`),
    CONSTRAINT FK_PAGE_IN_CATEGORY_PAGE_ID_PAGE_ENTITY_ID FOREIGN KEY (`page_id`) REFERENCES `page_entity`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PAGE_IN_CATEGORY_PAGE_ID_PAGE_CATEGORY_ENTITY_ID FOREIGN KEY (`category_id`) REFERENCES `page_category_entity`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
);
