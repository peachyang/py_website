            ...
            try {
                ...
                if ($customer) {
                    ...
                    $mailer->send((new TemplateModel($collection[0]))
                                    ->getMessage(['type' => $this->translate($this->storage['count'] > 0 ? 'gathered' : 'used'), 'points' => abs($this->storage['count']), 'balance' => $customer['rewardpoints'], 'username' => $customer['username']])
